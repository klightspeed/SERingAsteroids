...
{
    public class MaterialLeafOctree : MaterialLeaf
    {
        public override OctreeStorageChunkType Type => OctreeStorageChunkType.MaterialLeafOctree;
        ...
        {
            return SizeOf(TreeHeight) + SizeOf(DefaultContent) + Nodes.Sum(e => SizeOf(e.Key) + SizeOf(e.ChildMask) + SizeOf(e.Data));
        }
        ...
        public static bool TryRead(ByteArrayBuffer buffer, uint version, out MaterialLeafOctree data)
        {
            data = null;
